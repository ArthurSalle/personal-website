...
export const experiences: Experience[] = [
  {
    ...
    description: {
      en: "I design and ship web and mobile products end-to-end: scoping, spec, development, production. Depending on the mission, I start from scratch or take over an existing product, on my own or within an existing team. I also work within UndefinedHQ, a collective of two developers and a designer: shared design work, cross code reviews, joint delivery.",
